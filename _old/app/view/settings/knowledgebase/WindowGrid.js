Ext.define('AM.view.knowledgebase.WindowGrid', {
		...
		this.items = [
			    {
					...
					tbar: [
						...
						{text: Lan.editknowledgebase,   id:'buttonKnowledgebaseEdit',		disabled: true,	glyph: 'xf044@FontAwesome',	 action: 'buttonKnowledgebaseEdit'   },'-',
						{text: Lan.removeknowledgebase, id:'buttonKnowledgebaseRemove',		disabled: true, glyph: 'xf014@FontAwesome', action: 'buttonKnowledgebaseRemove' },
						'->',	
